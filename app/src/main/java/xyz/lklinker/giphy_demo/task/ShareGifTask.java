...
import xyz.lklinker.giphy_demo.Utils;

public class ShareGifTask extends AsyncTask<Void, Void, File> {
    ...
    public ShareGifTask(Context context, String gifUrl) {
    ...
    protected void onPostExecute(File result) {
        ...
        if (result != null) {
            Uri contentUri = Utils.getImageContentUri(context, result);
